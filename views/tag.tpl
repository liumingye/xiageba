...
<head>
    <meta charset="UTF-8">
    <title>{{.Tagname}} 第{{.Page}}页 - 下歌吧 - 全网音乐 高品质MP3 在线免费下载 免费播放</title>
    <meta name="keywords" content="{{.Tagname}},下歌吧,下歌网,音乐下载,无损音乐,歌曲下载,高品质音乐,歌曲搜索,音乐免费下载,MP3下载,收费音乐免费下载,付费音乐免费下载,在线mp3下载网站"/>
    <meta name="description" content="{{.Tagname}} - 下歌吧在线音乐搜索，可以在线免费下载全网MP3付费歌曲、流行音乐、经典老歌等。曲库完整，更新迅速，试听流畅，支持高品质|无损音质">
    {{template "header.tpl" .}}
</head>
        ...
        <div class="body-box mt-3 p-3">
            <div class="d-flex justify-content-between align-items-center">
                <div class="fs-10 fw-bold">
                    <span class="text-black-50">标签相关</span>
                    <a href="/s/{{.Tagname}}" class="song-title">{{.Tagname}}</a>
                </div>
